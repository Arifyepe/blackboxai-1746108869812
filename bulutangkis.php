...
$stmt = $conn->prepare("SELECT * FROM products WHERE category = 'bulutangkis' ORDER BY type, brand, name");
$stmt->execute();
...
<head>
    ...
    <title>Bulutangkis - Sports Shop</title>
    ...
    <div class="container mx-auto px-4 py-8">
        ...
        <section class="mb-12">
            ...
            <div class="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-6">
                <?php
                $teams = [
                    'Indonesia', 'Malaysia', 'China', 'Denmark', 'Jepang',
                    'Korea Selatan', 'Thailand', 'USA', 'India', 'Taiwan'
                ];
        ...
        <!-- Shoes Section -->
        <section class="mb-12">
            <h2 class="font-russo text-2xl mb-6">Sepatu Bulutangkis</h2>
            <div class="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-6">
                <?php for($i = 1; $i <= 20; $i++): ?>
                <div class="bg-white rounded-lg shadow-lg overflow-hidden">
        ...
        <!-- Headband Section -->
        <section class="mb-12">
            <h2 class="font-russo text-2xl mb-6">Headband</h2>
            <div class="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-6">
                <?php for($i = 1; $i <= 10; $i++): ?>
                <div class="bg-white rounded-lg shadow-lg overflow-hidden">
